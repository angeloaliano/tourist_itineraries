...
for λ in [0,1]
    ...
    if λ < 0.5
        ...
        Z10 .= z1
        Z20 .= z2
        FileIO.save("50_Path_Normal0.jld2","RH",Path)
        FileIO.save("50_Ordem_Normal0.jld2","RH",Ordem)
        FileIO.save("50_Visita_Normal0.jld2","RH",Visita)
        FileIO.save("50_Horas_Normal0.jld2","RH",Horas)
    else
        GAP[2]=mean(g)
        CPU1[2]=Cputime1
        CPU2[2]=sum(tem)
        Z11 .= z1
        Z21 .= z2
        FileIO.save("50_Path_Normal1.jld2","RH",Path)
        FileIO.save("50_Ordem_Normal1.jld2","RH",Ordem)
        FileIO.save("50_Visita_Normal1.jld2","RH",Visita)
        FileIO.save("50_Horas_Normal1.jld2","RH",Horas)
    end
end
...
for λ ∈ [0.2,0.5,0.8]
    ...
    CPU1[k]=Cputime1
    CPU2[k]=sum(tem)
    FileIO.save("50_Path_Normal$compr.jld2","RH",Path)
    FileIO.save("50_Ordem_Normal$compr.jld2","RH",Ordem)
    FileIO.save("50_Visita_Normal$compr.jld2","RH",Visita)
    FileIO.save("50_Horas_Normal$compr.jld2","RH",Horas)
end

FileIO.save("50_CPU_Normal1.jld2","RH",CPU1)
FileIO.save("50_CPU_Normal2.jld2","RH",CPU2)
FileIO.save("50_GAP_Normal.jld2","RH",GAP)


#-------------------------------------------------------

Path0 = FileIO.load("50_Path_Normal0.jld2","RH")
Path1 = FileIO.load("50_Path_Normal1.jld2","RH")
Path2 = FileIO.load("50_Path_Normal2.jld2","RH")
Path5 = FileIO.load("50_Path_Normal5.jld2","RH")
Path8 = FileIO.load("50_Path_Normal8.jld2","RH")

Ordem0 = FileIO.load("50_Ordem_Normal0.jld2","RH")
Ordem1 = FileIO.load("50_Ordem_Normal1.jld2","RH")
Ordem2 = FileIO.load("50_Ordem_Normal2.jld2","RH")
Ordem5 = FileIO.load("50_Ordem_Normal5.jld2","RH")
Ordem8 = FileIO.load("50_Ordem_Normal8.jld2","RH")
...
CPU1_Normal = FileIO.load("50_CPU_Normal1.jld2","RH")
CPU2_Normal = FileIO.load("50_CPU_Normal2.jld2","RH")
GAP_Normal = FileIO.load("50_GAP_Normal.jld2","RH")
